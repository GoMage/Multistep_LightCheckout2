...
namespace GoMage\SuperLightCheckout\Observer;

use GoMage\SuperLightCheckout\Model\Config\CheckoutConfigurationsProvider;
use GoMage\SuperLightCheckout\Model\CustomerLoginByEmailAndPassword;
...
class CreateCustomerBeforeSubmitCheckout implements ObserverInterface
{
    ...
    public function execute(Observer $observer)
    {
        ...
        if (isset($additionalData['password']) && $additionalData['password']) {
            ...
            $checkoutMode = (int)$this->checkoutConfigurationsProvider->getRegistrationSettings()->getCheckoutMode();
