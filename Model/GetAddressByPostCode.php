...
use GoMage\SuperLightCheckout\Api\GetAddressByPostCodeInterface;
use GoMage\SuperLightCheckout\Model\Api\Factory;
use GoMage\SuperLightCheckout\Model\Config\CheckoutConfigurationsProvider;
use GoMage\SuperLightCheckout\Model\Config\Source\AutofillByZipCode\Mode;
use GoMage\SuperLightCheckout\Model\GetAddressByPostCode\ResponseDataInterfaceFactory;
...
class GetAddressByPostCode implements GetAddressByPostCodeInterface
{
    ...
    {
        if (!$this->checkoutConfigurationsProvider->getAutofillByZipCode()->getAutoFillByZipCodeIsEnabledZipCaching()) {
            return null;
        }
    ...
    {
        $result = null;
        $apiModes = $this->checkoutConfigurationsProvider->getAutofillByZipCode()->getAutoFillByZipCodeApiMode();
    ...
    private function getResponseData($address)
    {
        ...
        $isDisabledAddressFields = $this->checkoutConfigurationsProvider->getAutofillByZipCode()
                ->getAutoFillByZipCodeIsDisabledAddressFields();
