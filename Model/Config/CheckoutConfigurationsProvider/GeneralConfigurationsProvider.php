...
class GeneralConfigurationsProvider
{
    ...
    const XML_PATH_LIGHT_CHECKOUT_GENERAL_PAGE_TITLE = 'gomage_super_light_checkout_configuration/general/page_title';
    const XML_PATH_LIGHT_CHECKOUT_GENERAL_PAGE_CONTENT = 'gomage_super_light_checkout_configuration/general/page_content';
    const XML_PATH_LIGHT_CHECKOUT_GENERAL_BILLING_AND_SHIPPING_ARE_THE_SAME_CHECKBOX = 'gomage_super_light_checkout_configuration/general/billing_and_shipping_address_are_the_same_checked';
    ...
    {
        return $this->scopeConfig->getValue(self::XML_PATH_LIGHT_CHECKOUT_GENERAL_BILLING_AND_SHIPPING_ARE_THE_SAME_CHECKBOX);
    }
