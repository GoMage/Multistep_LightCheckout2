...
class GeneralConfigurationsProvider
{
    ...
    const XML_PATH_SUPER_LIGHT_CHECKOUT_GENERAL_ENABLE_DISCOUNT_CODES = 'gomage_super_light_checkout_configuration/general/enable_discount_codes';
    /**#@-*/
    ...
    {
        return $this->scopeConfig->getValue(self::XML_PATH_SUPER_LIGHT_CHECKOUT_GENERAL_ENABLE_DISCOUNT_CODES);
    }
}
