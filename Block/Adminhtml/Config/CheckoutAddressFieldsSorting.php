...
namespace GoMage\SuperLightCheckout\Block\Adminhtml\Config;

use GoMage\SuperLightCheckout\Model\Config\CheckoutAddressFieldsSorting\FieldsDataTransferObject;
...
class CheckoutAddressFieldsSorting extends Field
{
     ...
     * @var string
     */
    protected $_template = 'GoMage_SuperLightCheckout::config/checkout_address_fields_sorting.phtml';
